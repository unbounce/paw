...
RUN ./sonar-scanner-3.2.0.1227-linux/bin/sonar-scanner -Dsonar.projectKey=sast-test -Dsonar.organization=unbouncerabbit-github -Dsonar.sources=. -Dsonar.host.url=https://sonarcloud.io -Dsonar.login=${SONAR_LOGIN} -Dsonar.branch.name=github -X
